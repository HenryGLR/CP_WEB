      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
            Sua comida favorita
            <span className="text-orange-500"> onde você estiver.</span>
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            ...
            <button className="border border-gray-300 text-gray-700 px-7 py-3 rounded-xl font-semibold hover:bg-gray-100 transition duration-300">
              Ver restaurantes
            </button>
          </div>
          ...
          <div className="mt-10 flex gap-8">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900">+5 mil</h3>
